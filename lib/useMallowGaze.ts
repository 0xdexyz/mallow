...
/**
 * Drives the Mallow character video: on desktop the pupils track the
 * pointer by seeking a calibrated frame table; on mobile (or with reduced
 * motion) it loops normal playback instead.
 */
export function useMallowGaze(videoRef: RefObject<HTMLVideoElement | null>) {
  useEffect(() => {
